...
/// <class name="UnsortedBinarySearch"> Implementación de la búsqueda binaria sin ordenar </class>
...
namespace DivideConquer.Algorithms {
  class UnsortedBinarySearch<S, T> : Template<S, int[]>
      where S : Search<T>
      where T : IComparable {
    /// <summary>
    /// Constructor of BinarySearch.
    /// </summary>
    public UnsortedBinarySearch() {
      this._subproblems = "2";
